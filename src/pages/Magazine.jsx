...
const MOCK_MAGAZINES = {
    'vol-1': {
        ...
        description: "Daily 1-Brand Exclusive Essay & Visit Guide: Vacheron Constantin Seoul Flagship Atelier (2026.8.30 - 10.15).",
        descriptionKr: "디지털 픽셀의 시대를 넘어, 270년 아날로그 시간에 대한 위엄을 깎아내는 바쉐론 콘스탄틴의 서울 헤리티지 성소 비평 & 방문 가이드.",
        sections: [
            {
